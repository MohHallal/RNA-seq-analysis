...
#Récupération des emplacements des tables de comptage
...
row.names(gorpol_reads) <- data_frames[[1]]$target_id
...
sink("DESEq2/deseq2_summary.txt")
paste("The number of DGE found with pvalue of 0.05: ",nrow(significant_genes))
write.csv(results_gorpol_pval, "DESEq2/sign_genes_pvalue_0.05.csv")
